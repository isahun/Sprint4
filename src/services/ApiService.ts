//Responsibility: Fetching data, talking to the internet. It is AGNOSTIC, has no idea what a joke is or what UI is, what is returning or why are we calling for the data to begin with. Only knows "u gimme URL --> i give you data"
